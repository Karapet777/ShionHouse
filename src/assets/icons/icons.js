export const CachIcom = ({ className }) => {
  return (
    <div className={className}>
      ...
      >
        ...
        <path
          ...
          transform="translate(-108.216 -233.804)"
          fill="#1d2547"
        />
        <path
          id="Path_229"
          data-name="Path 229"
          d="M264,304h1.572v1.572H264Zm0,0"
          transform="translate(-238.071 -277.089)"
          fill="#1d2547"
        />
        <path
          id="Path_230"
          data-name="Path 230"
          d="M72,304h1.572v1.572H72Zm0,0"
          transform="translate(-64.931 -277.089)"
          fill="#1d2547"
        />
        <path
          id="Path_231"
          data-name="Path 231"
          d="M88,56h7.073v1.572H88Zm0,0"
          transform="translate(-79.359 -50.503)"
          fill="#1d2547"
        />
        <path
          id="Path_232"
          data-name="Path 232"
          d="M176,56h1.572v1.572H176Zm0,0"
          transform="translate(-158.715 -50.503)"
          fill="#1d2547"
        />
        <path
          id="Path_233"
          data-name="Path 233"
          d="M208,56h1.572v1.572H208Zm0,0"
          transform="translate(-187.572 -50.503)"
          fill="#1d2547"
        />
        <path
          id="Path_234"
          data-name="Path 234"
          d="M240,56h1.572v1.572H240Zm0,0"
          transform="translate(-216.429 -50.503)"
          fill="#1d2547"
        />
      </svg>
    </div>
